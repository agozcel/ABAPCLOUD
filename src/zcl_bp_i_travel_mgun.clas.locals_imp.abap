CLASS lhc_ZI_TRAVEL_M_GUN DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
 TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_GUN.
...
METHODS set_status_completed       FOR MODIFY importing  keys FOR ACTION travel~acceptTravel RESULT result.
    METHODS get_features FOR FEATURES
      IMPORTING keys REQUEST requested_features FOR zi_travel_m_gun RESULT result.

ENDCLASS.

CLASS lhc_ZI_TRAVEL_M_GUN IMPLEMENTATION.

METHOD validate_customer.

READ ENTITY zi_travel_m_gun\\travel FROM VALUE #(
...
MODIFY ENTITIES OF zi_travel_m_gun IN LOCAL MODE
       ENTITY travel
  ...
  READ ENTITIES OF zi_travel_m_gun IN LOCAL MODE
       ENTITY travel
